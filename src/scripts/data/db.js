...
export const queueStory = (story) => writeMany(PENDING_STORE, [story]);
export const getPendingStories = () => readAll(PENDING_STORE);
export const deletePendingStory = (id) => removeOne(PENDING_STORE, id);
